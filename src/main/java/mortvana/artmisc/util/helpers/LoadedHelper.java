package mortvana.artmisc.util.helpers;
...
public class LoadedHelper {
	...
	public static boolean isImmersiveEngineeringLoaded = Loader.isModLoaded("ImmersiveEngineering");
	public static boolean isExNihiloLoaded = Loader.isModLoaded("exnihilo");
	public static boolean isGeoStrataLoaded = Loader.isModLoaded("GeoStrata");
	public static boolean isExAstrisLoaded = Loader.isModLoaded("exastris");
